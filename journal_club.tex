...
% 0:55 -- Jan
\begin{SWNFrame}{WHAT IS A CONDITIONAL GAN?}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.62\textwidth}
\PaperAsset[width=\linewidth]{gan-workflow.png}
\LitSource{Conceptual workflow based on Rajabi et al. (2023), Fig. 2, p. 5.}
\end{column}
\begin{column}{0.34\textwidth}
\textbf{Conditional:} the demand image controls which pressure image is generated.

\textbf{Generator:} produces the expected leak-free pressure image.

\textbf{Discriminator:} learns to distinguish real and generated pressure patches.

\textbf{Training loop:} both networks improve competitively; L1 loss preserves pixel accuracy.

\textbf{After training:} SSIM compares predicted normal pressure with the observation.
\end{column}
\end{columns}
\end{SWNFrame}
