...
\JCBullets{
  \item \textbf{Problem and research question:} why leak detection and localization in water distribution networks remain difficult.
  \item \textbf{Proposed method:} how the CDCGAN learns leak-free demand--pressure behavior and identifies anomalies.
  \item \textbf{Evaluation and results:} how detection accuracy, localization performance, and real-time operation are tested.
  \item \textbf{Critical assessment:} strengths, limitations, and assumptions that affect practical deployment.
  \item \textbf{Conclusion:} implications, recommended next tests, and the final take-home message.
}
\end{SWNFrame}
